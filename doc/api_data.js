        ...
        "Parameter": [
          {
            ...
            "type": "String",
            "optional": false,
            "field": "clientReferralId",
            "description": "<p>Referral ID of client.</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "NoReferralIdExists",
            "description": "<p>No referral id exists</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "BonusAlreadyClaimed",
            "description": "<p>Provided client already claimed for bonus</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "PaymentTxNotFound",
            "description": "<p>Provided client not made first payment yet.</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "NoReferralIdExists-Response:",
